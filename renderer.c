...
// do everything in one thread in MAIN
// rip out SDL_Mixer and SDL_Image dep's if we can, for simplicity.
// run project through CLion and remove ALL unused COMMON.C declarations.
